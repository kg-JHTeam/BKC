package com.bkc.businessInformation.controller;
...
public class BusinessInformationController {
	...
	public String businessinformationUpdate(Model model,
			@RequestParam String address, @RequestParam String tel,
			@RequestParam String business_num, @RequestParam String copyright,
			@RequestParam String ceo_name){
