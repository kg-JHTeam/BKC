		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid">
					<h1 class="mt-4">유의사항 등록</h1>
					<div class="card mb-4">
						<div class="card-body">
							<div class="table-responsive">
								<form action="${contextPath}/delivery/admin/CautionUpload.ad" method="get">
									<div class="container-fluid">
										<br>
										<!-- DataTales Example -->
										<div class="card shadow mb-4">
											<div class="card-header py-3">
												<h6 class="m-1 font-weight-bold text-primary">유의사항 등록</h6>
											</div>
											<div class="card-body">
												<!-- 전체 frame -->
												<ul>
												...
												<div align="right">
													<a href="${contextPath }/delivery/admin/cautionList.ad"
