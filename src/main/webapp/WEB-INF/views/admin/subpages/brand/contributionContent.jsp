		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid">
					<h1 class="mt-4">CONTRIBUTION수정</h1>
					<div class="card mb-4">
						<div class="card-body">
							<div class="table-responsive">
								<form role="form" action="${contextPath}/admin/modifyContribution.ad" method="post" enctype="multipart/form-data">
									<div class="form-row">
										<div class="form-group col-md-2">
												<label>번호</label> 
												<input class="form-control" name='seq' value="${ContributionVO.seq}" />
										</div>
										<div class="form-group col-md-12">
												<label>내용</label> 
												<textarea class="form-control" name='content' value="${ContributionVO.content}" />${ContributionVO.content}</textarea>
										</div>
										<div class="form-group col-md-12">
												<label>이미지</label> 
									...
									<div>
										...
										<input class="btn btn-danger" type="button" value="삭제" onclick="javascript:deleteContribution(${ContributionVO.seq})">
									</div>
								</form>
							</div>
						</div>
