         ...
         <div class="tab_aboutCon web_container" id="abo">
            <div class="about01">
               ...
               <p>고객 여러분, 안녕하십니까. 항상 bkc에 많은 관심과 응원을 보내주시는 고객 여러분께 깊은 감사의 말씀을
                  드립니다. 저희 bkc는 투명경영, 상생경영을 바탕으로 고객에게 신뢰받는 브랜드로 성장하기 위해 끊임없이 노력하여
                  빛나는 성장을 기록하고 있습니다. bkc는 더 맛있고! 더 깨끗한! 더 친절한! 브랜드로 모든 고객의 감성을 만족시켜
                  사랑받는 브랜드가 되기 위해 전국 bkc가맹점과 본사 임직원 모두가 최선을 다할 것입니다. bkc만의 독보적인 신메뉴
                  개발에 집중하여 고객에게 폭발적인 인기를 얻는 치킨 업계의 새로운 패러다임을 주도하는 브랜드가 되겠습니다. 안전한
                  먹거리 제공으로 고객에게 신뢰받는 브랜드로 끊임없이 성장하여 업계 주도하는 브랜드로 우뚝 서겠습니다. 고객 응대와
                  서비스로 감성을 만족시켜 사랑받는 기업으로 기억될 수 있도록 노력하겠습니다. 또한, bkc는 사회공헌활동인
                  BSR(bkc+CSR)을 통해 다양하고 지속적인 나눔과 봉사활동을 진행하고 있으며, 앞으로도 기업의 사회적 책임을
                  다하는 bkc가 될 수 있도록 더욱 노력할 것입니다. 앞으로도 저희 bkc는 고객에게 신뢰받는 브랜드로 성장하기 위해
                  다양한 노력을 아끼지 않을 것입니다. 전국 bkc가맹점과의 상생을 기반으로 끊임없이 발전하는 bkc가 되도록
                  하겠습니다. 고객님들의 변함없는 사랑과 관심 부탁드립니다. 감사합니다. -BKC 치킨 CEO 민경민</p>
            </div>
            <div class="about02">
               <h3>BKC KOREA</h3>
