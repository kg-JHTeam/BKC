		...
		<div class="locationWrap WEB">
			<div class="event_web_container">
				<div class="page_navi">
					...
					</a> <a class="arrow"><span>이벤트</span>&nbsp;>&nbsp;</a><a class="arrow"> <span> 진행중 </span></a>
				</div>
			</div>
		</div>
			...
			<div class="event_web_container">
				<div class="subtitWrap">
					...
					<div class="tab01 m_shadow">
						<ul>
							<li>
								<button type="button" onclick="location.href='${pageContext.request.contextPath }/event/eventPageAll.do'">
									<span>전체</span>
								</button>
							</li>
							<li class='on'>
				...
				<div class="tab_cont m_bg_basic">
					<ul class="eventBox">
						<c:forEach var="eventConList" items="${eventConList}">
								<li>
									<div class="event_list_img">
										 <img
											src="${eventConList.img_title}"
											 style="display: inline; opacity: 1;">	
									</div>
									<div class="cont">
										<p class="tit">
											<a type="hidden" href="${pageContext.request.contextPath}/event/eventDetail.do?seq=${eventConList.seq}">
												<strong>${eventConList.start_date}</strong> ~ 
												<strong>${eventConList.end_date}</strong>
											</a>
										</p>
									</div>							
								</li>
