		...
		<div class="contentsBox01 bg_w">
			<div class="event_web_container">
				...
				<div class="tab_cont m_bg_basic">
					<ul class="eventBox">
						<c:forEach var="eventEndList" items="${eventEndList}">
								<li>
									<div class="event_list_img">
										 <img
											src="${eventEndList.img_title}"
											 style="display: inline; opacity: 1;">	
									</div>
									<div class="cont">
										<p class="tit">
											<a type="hidden" href="${pageContext.request.contextPath}/event/eventDetail.do?seq=${eventEndList.seq}">
												<strong>${eventEndList.start_date}</strong> ~ 
												<strong>${eventEndList.end_date}</strong>
											</a>
										</p>
									</div>							
								</li>
