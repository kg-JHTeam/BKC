		...
		<div class="contentsBox01">
			<div class="term_web_container">
				<div class="subtitWrap">
					<h3 class="page_tit">개인정보취급방침</h3>
					<div class="tab01 m_shadow">
						<ul>
							<li>
								<button type="button"
									onclick="location.href='${contextPath}/terms.do'">
									<span>이용약관</span>
								</button>
							</li>
							<li class='on'>
								<button type="button"
									onclick="location.href='${contextPath}/termsPrivacy.do'">
									<span>개인정보취급방침</span>
								</button>
							</li>
							<li>
								<button type="button"
									onclick="location.href='${contextPath}/termsEmail.do'">
									<span>이메일 약관</span>
								</button>
							</li>
						</ul>
				...
				<div class="tab_cont">
					<h4 class="hide">개인정보 취급 방침</h4>
					<div class="container02 policyWrap">
						<div class="titbox">
							<div class="policy_switch">
								<label class="switch01"><input type="radio"
									name="rdoTab" checked="checked"><strong>개인정보처리방침</strong></label>
							</div>
							
						</div>
						<div class="auth_cont">
							<pre>${ termsPrivacy.content01}</pre>
							<pre>${ termsPrivacy.content02}</pre>
							<pre>${ termsPrivacy.content03}</pre>
							<pre>${ termsPrivacy.content04}</pre>
						</div>
					</div>
				</div>
			</div>
