	...
	<div class="menudetailWrap">
		...
		<div class="menudetailcontentsbox02">
			<div class="menudetailweb_container">
				<div class="intro_txt">
					<strong class="tit"> <span>${beerzone.product_name}</span>
					</strong>
					<p class="subtxt">
						<span>${beerzone.description}</span>
					</p>
				</div>
		...
		<div class="menudetailcontents">
			<div class="web_container">
				...
				<ul class="prd_submenu">
					<li>
						<div class="prd_img">
							<span> <img src="${beerzone.path}">
							</span>
						</div>
						<div class="cont">
							<p class="tit">
								<strong>${beerzone.product_name}</strong>
							</p>
							<p class="tit_content">
								<span>${beerzone.description}</span>
							</p>
					...
					<div class="othermenu_slider">
						<div class="slide">
							<div class="slider prd_img responsive">
								<c:forEach var="beer" items="${ beerzoneList}">
									<a
										href="${contextPath}/menuInform/beerzonedetail.do?product_serial=${beer.product_serial}"
										class="btn_detail"> <span style="display: block;">
											<img src="${ beer.path}">
											<div class="cont">
												<p class="tit">
													<strong>${ beer.product_name}</strong>
												</p>
											</div>
									</span>
									</a>
