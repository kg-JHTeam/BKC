...
<link rel="stylesheet"
	href="${contextPath}/resources/css/subpages/menuInform/menuInform.css">
...
<script
	src="${contextPath}/resources/js/subpages/menuInform/menuInform.js"></script>
		...
		<div class="menuContentsWrap">
			<div class="WEB locationWrap">
				<div class="Web_container">
					<div class="page_navi">
						<a href="${contextPath }/"> <span>HOME</span> </a>> <a
							href="${contextPath }/menuInform/chickenMenu.do"><span> 메뉴소개 </span></a>
					</div>
				</div>
			</div>
			<div class="menu_contentsBox01 bg_w">
				<div class="menu_container">
					...
					<div class="tab_cont">
						<ul class="menu_list">
							<c:forEach var="chickenmenu" items="${chickenMenuList}">
								<li>
									<div class="menu_list_img">
										<span> <img
											src="${chickenmenu.path }"
											class style="display: inline; opacity: 1;">
										</span>
									</div>
									<div class="cont">
										<p class="tit">
											<strong>${chickenmenu.product_name }</strong>
										</p>
									</div> <a href="${contextPath}/menuInform/chickenmenudetail.do?product_serial=${chickenmenu.product_serial}" class="btn_detail"> <span>Details</span>
								</a>
								</li>
							</c:forEach>
						</ul>
