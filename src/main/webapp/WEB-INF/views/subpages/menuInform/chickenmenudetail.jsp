            ...
            <div class="menudetailcontainer">
                <div class="menudetailpage_navi">
                   <a href="${contextPath }/">
					...
					<a href="${contextPath}/menuInform/chickenMenu.do">
						<span>치킨메뉴</span>&nbsp;>&nbsp;</a>
						<a href="#" >
        ...
        <div class="menudetailcontentsbox02">
            <div class="menudetailweb_container">
                <div class="intro_txt">
                    ...
                    <p class="subtxt">
                        <span>${chickenMenu.description }</span>
                    </p>
                </div>
                ...
                <div class="titbox">
                    ...
                    <div class="othermenu_slider">
                        <div class="slide">
                            ...
                            <c:forEach var="chicken" items="${ chickenMenuList}">
                               <a href="${contextPath}/menuInform/chickenmenudetail.do?product_serial=${chicken.product_serial}" class="btn_detail">
