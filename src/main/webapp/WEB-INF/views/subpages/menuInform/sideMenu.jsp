				...
				<div class="Web_container">
					<div class="page_navi">
						<a href="${contextPath }/"> <span>HOME</span> </a>> <a
							href="${contextPath }/menuInform/sideMenu.do"><span> 메뉴소개 </span></a>
					</div>
				</div>
			</div>
							...
							<c:forEach var="sidemenu" items="${sidemenuList}">
								<li>
									<div class="menu_list_img">
										<span> <img src="${sidemenu.path}" class
									...
									href="${contextPath}/menuInform/sidemenudetail.do?product_serial=${sidemenu.product_serial}"
									class="btn_detail"> <span>Details</span>
								</a>
								</li>
							</c:forEach>
						</ul>
